...
export const DEFAULT_PERMISSIONS: ReadonlyArray<{
  ...
  { module: 'sales', action: 'delete', name: 'Eliminar ventas', description: 'Permite eliminar ventas (incluye completadas, con reversión de stock y caja)' },
  ...
  { module: 'bank_accounts', action: 'view', name: 'Ver cuentas bancarias', description: 'Permite ver cuentas bancarias' },
  { module: 'bank_accounts', action: 'create', name: 'Crear cuentas bancarias', description: 'Permite crear cuentas bancarias' },
  { module: 'bank_accounts', action: 'update', name: 'Modificar cuentas bancarias', description: 'Permite editar cuentas bancarias' },
  { module: 'bank_accounts', action: 'delete', name: 'Eliminar cuentas bancarias', description: 'Permite desactivar cuentas bancarias' },
